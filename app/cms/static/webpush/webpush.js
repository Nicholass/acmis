	  ...
	  navigator.serviceWorker.register(serviceWorker)
	    .then(function(reg) {
			if (!(reg.showNotification)) {
		        console.error('Showing Notification is not suppoted in your browser');
		        return;
		    }
		    ...
		    if (Notification.permission === 'denied') {
		      console.error('The Push Notification is blocked from your browser.');
		      return;
		    }

		    // Check if push messaging is supported
		    if (!('PushManager' in window)) {
		      console.error('Push Notification is not available in the browser');
		      return;
		    }
