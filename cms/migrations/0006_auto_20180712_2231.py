# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2018-07-12 19:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='cmsprofile',
            name='language',
            field=models.CharField(blank=True, choices=[('ru', 'Russian'), ('en', 'English'), ('uk', 'Ukrainian')], default='uk', max_length=10, verbose_name='Language'),
        ),
        migrations.AddField(
            model_name='cmsprofile',
            name='post_count',
            field=models.IntegerField(blank=True, default=0, verbose_name='Post count'),
        ),
        migrations.AddField(
            model_name='cmsprofile',
        ...
        migrations.AddField(
            model_name='cmsprofile',
            name='signature',
            field=models.TextField(blank=True, max_length=400, verbose_name='Signature'),
        ),
        migrations.AddField(
            model_name='cmsprofile',
            name='signature_html',
            field=models.TextField(blank=True, max_length=430, verbose_name='Signature HTML Version'),
        ),
        migrations.AddField(
            model_name='cmsprofile',
            name='time_zone',
