...
'Visit timeout help'			=>	'Количество секунд простоя перед тем, как пользователь будет разлогинен',
...
'Topic review label'			=>	'На странице ответа', // Topic review
...
// Features section
'Features general'				=>	'Основные настройки функционала PunBB', // General PunBB features which are optional
...
'Subscriptions label'			=>	'Разрешить пользователям подписку на получение уведомлений о новых ответах в теме по e-mail.',
...
'Topic views label'				=>	'Отображать количество просмотров тем. Отключите функцию если существует высокая загруженность сервера.',
...
'User info label'				=>	'Отображать место нахождения пользователя, дату регистрации, количество сообщений, адреса e-mail и URL в сообщениях.',
...
'New reg info'					=>	'Можно использовать проверку всех новых регистраций. Когда проверка регистраций включена, пользователь получает на e-mail сообщение со ссылкой активации. Он может воспользоваться ею для авторизации. Эта функция также требует от пользователя подтверждать адрес e-mail, если он захочет его сменить после регистрации. Это эффективный путь ограничить пустые регистрации и быть уверенным, что у всех пользователей в профиле указан реальный адрес e-mail.',
...
'Allow banned label'			=>	'Разрешить регистрацию с адресом e-mail, который находится в чёрном списке (забанен).',
'Allow dupe label'				=>	'Разрешить регистрацию с адресом e-mail, который уже принадлежит другому пользователю.',
...
// Email section
'E-mail addresses'				=>	'E-mail адреса и список рассылки',
...
'Error invalid admin e-mail'	=>	'Введенный E-mail адрес администратора содержит ошибку.',
'Error invalid web e-mail'		=>	'Введенный E-mail адрес вебмастера содержит ошибку.',

// Maintenance section
'Maintenance head'				=>	'Установка режима профилактики и оформление сообщения о применении данного режима',
'Maintenance mode info'			=>	'<strong>Важно!</strong> Форум будет доступен только Администраторам. Данный режим следует использовать, если нужно закрыть форум для проведения каких-либо работ и изменению настроек.',
