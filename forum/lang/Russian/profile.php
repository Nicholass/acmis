...
'Ban user info'				=>	'Забанить пользователя через консоль администрирования.',
...
'No avatar info'			=>	'Вы ещё не загрузили ни одного аватара.',
...
'Pass not match'			=>	'Пароли различны.',
'E-mail not match'			=>	'E-mail адреса различны.',
...
'E-mail info'				=>	'<strong>Важно!</strong> На ваш новый e-mail адрес послано письмо содержащее активациионную ссылку. Для активации нового e-mail адреса необходимо пройти по той ссылке. Рекомендуется проверить правильность введённой информации.',
'Reg e-mail info'			=>	'<strong>Важно!</strong> На указанный e-mail адрес послано письмо содержащее активациионную ссылку. Для активации новой учётной записи адреса необходимо пройти по той ссылке. Это должно быть сделано в течении 72 часов, иначе аккаунт будет удалён.',
