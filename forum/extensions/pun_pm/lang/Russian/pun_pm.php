...
$lang_pun_pm = array(
	...
	'Non-existent username' => 'Пользователь \'%s\' не существует. Проверьте имя получателя.',
	...
	'Outbox full'			=> 'Количество исходящих личных сообщений достигло предела(%s).Необходимо удалить старые или ненужные из \'Входящих\'.',
	'Inbox almost full'		=> '<strong>Внимание!</strong> Количество входящих сообщений приблизилось к пределу(%s). Необходимо удалить старые или ненужные из \'Входящих\'. В случае достижения предела отправлять новые сообщения будет невозможно.',
	'Inbox overflow'		=> '<strong>Внимание!</strong> Количество входящих сообщений достигло предела(%s). Необходимо удалить старые или ненужные из \'Входящих\', чтобы иметь возможность отправлять личные сообщения.',
	'Outbox almost full'	=> '<strong>Внимание!</strong> Количество исходящих сообщений приблизилось к пределу(%s). Необходимо удалить старые или ненужные из \'Исходящих\'. В случае достижения предела получать новые сообщения будет невозможно.',
