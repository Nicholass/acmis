...
?>
			...
			<div class="frm-buttons">
				<span class="submit"><input type="submit" name="move_posts_s" value="<?php echo $lang_common['Next'] ?>" /></span>
...
// Get topics we can move the posts into
	...
	$forum_page['hidden_fields'] = array(
		...
		'tid'			=> '<input type="hidden" name="tid" value="'.$tid.'" />',
		'fid'			=> '<input type="hidden" name="fid" value="'.$fid.'" />',
		'move_to_forum'	=> '<input type="hidden" name="to_fid" value="'.$move_to_forum.'" />'
	);
...
?>
				...
				<div class="sf-set set2">
					<div class="sf-box checkbox">
						<span class="fld-input"><input type="checkbox" id="fld2" name="change_time" value="1" checked="checked" /></span>
...
// Move the posts
	...
	while ($cur_sel_forum = $forum_db->fetch_assoc($result))
	{
		...
		$query = array(
				...
				'WHERE'		=>	'post_id = '.$cur_sel_forum['id'] 
		);
